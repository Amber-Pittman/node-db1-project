...
-- the address is -"1 Hobbit-Hole" in "Bag End", postal code "111" and the 
...
-- (Stretch) Find all suppliers who have names longer than 20 characters. You 
-- can use `length(SupplierName)` to get the length of the name
